  ...
  <div class="panel">
    <div class="panel-heading clearfix">
     ...
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">Todas as Baixas</a>
     </div>
    </div>
          ...
          <th> Ação</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                <td id="s_name">
                  <input type="text" class="form-control" disabled id="sug_input" name="title" value="<?php echo remove_junk($product['name']); ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary">Atualizar Baixa</button>
                </td>
              </form>
              </tr>
           </tbody>
