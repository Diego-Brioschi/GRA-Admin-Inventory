...
<div class="login-page">
    <div class="text-center">
       <h3>Adicionar Grupo de Permissão</h3>
     </div>
     <?php echo display_msg($msg); ?>
      <form method="post" action="add_group.php" class="clearfix">
        <div class="form-group">
              <label for="name" class="control-label">Nome Permissão</label>
              <input type="name" class="form-control" name="group-name">
        </div>
        <div class="form-group">
              <label for="level" class="control-label">Nível Permissão</label>
        ...
        <div class="form-group clearfix">
                <button type="submit" name="add" class="btn btn-info">Adicionar Permissão</button>
        </div>
    </form>
</div>
