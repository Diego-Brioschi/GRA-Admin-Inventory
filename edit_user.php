     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          Atualizar Usuário: <?php echo remove_junk(ucwords($e_user['name'])); ?>
        </strong>
       </div>
       <div class="panel-body">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            ...
            <div class="form-group">
              <label for="level">Permissão</label>
            ...
            <div class="form-group clearfix">
                    <button type="submit" name="update" class="btn btn-info">Atualizar Usuário</button>
            </div>
        </form>
       </div>
     </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          Alterar Senha, Usuário: <?php echo remove_junk(ucwords($e_user['name'])); ?>
        </strong>
      </div>
      <div class="panel-body">
