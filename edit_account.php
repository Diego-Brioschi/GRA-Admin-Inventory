          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                <input type="file" name="file_upload" placeholder="Anexo" multiple="multiple" class="btn btn-default btn-file"/>
              </div>
              <div class="form-group">
      ...
      <div class="panel-body">
          <form method="post" action="edit_account.php?id=<?php echo (int)$user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    ...
                    <button type="submit" name="update" class="btn btn-info">Atualizar Perfil</button>
            </div>
        </form>
      </div>
    </div>
